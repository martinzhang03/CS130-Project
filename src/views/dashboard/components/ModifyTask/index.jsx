      ...
      <Modal
        ...
        footer={
          <>
            ...
            >
              <Button type="primary" onClick={clickSubmit}>Create</Button>
            </div>
          </>
        }
      >
        <Form form={form} layout="vertical" autoComplete="off">
              ...
              <Form.Item name="dependency" label="Dependency" rules={[{
                required: true,
          ...
          <Form.Item name="assign" label="Assign this task to" rules={[{
            required: true,
          ...
          <Form.Item name="desc" label="Description">
            <TextArea autoSize={{ minRows: 4, maxRows: 4 }} placeholder="Description" />
          </Form.Item>
        </Form>
      </Modal>
    </>
